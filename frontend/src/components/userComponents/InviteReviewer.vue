  ...
  <div>
    ...
    <el-row :gutter="40">
      <el-col :span="14">
        ...
        <el-table border ref="multipleTable" :data="userTable" tooltip-effect="dark" @selection-change="handleSelectionChange">
      ...
      <el-col :span="10">
        ...
        <el-table :data="invitationsTable" stripe border>
